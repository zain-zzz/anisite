        ...
        <div className={styles.headerLeft}>
          ...
          <div className={styles.searchBar} ref={wrapperRef}>
            <div className={styles.searchInner}>
              ...
              <button onClick={()=>onSearch(value)}><Image src={searchImg} alt=''/></button>
            </div>

            <div className={styles.dropdown}>
              {searchfocus && suggestions.map((show) => {
                return (
                <>
                <Link href={'/anime/' + show.id}>
                  <div className={styles.dropdownRow}>
                    ...
                    <img src={show.image}/>
                    <div>
                      <h2>{show.title.slice(0,35).trimEnd()} {show.title.length > 35 && '...'}</h2>
              ...
              {searchfocus && !!suggestions.length && <div className={styles.dropdownSearch}>
